...
\***************************************************************************/
if(!defined('SXGEO_MEMORY')){ define ('SXGEO_MEMORY', 1); }
if(!defined('SXGEO_FILE')){ define ('SXGEO_FILE', 0); }
if(!defined('SXGEO_BATCH')){ define ('SXGEO_BATCH',  2); }

$sgLibClassName = 'SxGeo';

if (!class_exists($sgLibClassName)) {
