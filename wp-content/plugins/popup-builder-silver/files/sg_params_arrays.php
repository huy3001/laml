...
class SgParamsArray {
	...
	public static function defaultDataArray() {

		$contactSuccessBehavior = array(
			array(
				"title" => "Show success message:",
				"value" => "showMessage",
				"info" => "",
				"data-attributes" => array(
					"class" => "js-contact-success-message"
				)
			...
			array(
				...
				"info" => "",
				"data-attributes" => array(
					"class" => "js-contact-success-redirect"
				)
		...
		$data = array();
		$data['contactSuccessBehavior'] = $contactSuccessBehavior;
