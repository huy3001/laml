...
function savePopupPreviewData() {
	...
	$subscriptionOptions = array(
		'subs-gdpr' => sgSanitize('subs-gdpr'),
		'subs-gdpr-label' => sgSanitize('subs-gdpr-label'),
		'subs-gdpr-text' => sgSanitize('subs-gdpr-text'),
	...
	$contactFormOptions = array(
		'contact-gdpr' => sgSanitize('contact-gdpr'),
		'contact-gdpr-label' => sgSanitize('contact-gdpr-label'),
		'contact-gdpr-text' => sgSanitize('contact-gdpr-text'),
