...
if (isset($_GET['id'])) {
	...
	// gdpr
	$sgSubsGdpr = @$subscriptionOptions['subs-gdpr'];
	$sgSubsGdprLabel = @$subscriptionOptions['subs-gdpr-label'];
	$sgSubsGdprText = @$subscriptionOptions['subs-gdpr-text'];
	// gdpr
	...
	// gdpr
	$sgContactGdpr = @$contactFormOptions['contact-gdpr'];
	$sgContactGdprLabel = @$contactFormOptions['contact-gdpr-label'];
	$sgContactGdprText = @$contactFormOptions['contact-gdpr-text'];
	// gdpr
...
$popupProDefaultValues = array(
	...
	'subs-gdpr' => false,// gdpr status
	'subs-gdpr-label' => 'Accept Terms',// gdpr label
	'subs-gdpr-text' => 'Popup Builder will use the information you provide on this form to be in touch with you and to provide updates and marketing.',// gdpr text
	...
	'contact-gdpr' => false,// gdpr status
	'contact-gdpr-label' => 'Accept Terms',// gdpr label
	'contact-gdpr-text' => 'Popup Builder will use the information you provide on this form to be in touch with you and to provide updates and marketing.',// gdpr text
...
// gdpr
$subsGdpr = sgBoolToChecked($popupProDefaultValues['subs-gdpr']);
$subsGdprLabel = $popupProDefaultValues['subs-gdpr-label'];
$subsGdprText = $popupProDefaultValues['subs-gdpr-text'];
// gdpr
...
// gdpr
$contactGdpr = sgBoolToChecked($popupProDefaultValues['contact-gdpr']);
$contactGdprLabel = $popupProDefaultValues['contact-gdpr-label'];
$contactGdprText = $popupProDefaultValues['contact-gdpr-text'];
// gdpr
...
// gdpr
$sgSubsGdpr = @sgSetChecked($sgSubsGdpr, $subsGdpr);
// gdpr
...
// gdpr
$sgContactGdpr = @sgSetChecked($sgContactGdpr, $contactGdpr);
// gdpr
...
// gdpr
$sgSubsGdprLabel = @sgGetValue($sgSubsGdprLabel, $subsGdprLabel);
$sgSubsGdprText = @sgGetValue($sgSubsGdprText, $subsGdprText);
// gdpr
...
// gdpr
$sgContactGdprLabel = @sgGetValue($sgContactGdprLabel, $contactGdprLabel);
$sgContactGdprText = @sgGetValue($sgContactGdprText, $contactGdprText);
// gdpr
