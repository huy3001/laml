...
/**
 * Custom class for register post types.
 *
 * @since 1.0.0
 */
class Custom_Cherry_Projects_Registration {
...
/**
 * Override Cherry Projects class
 */
if ( class_exists('Cherry_Projects_Registration') ) {
    new Custom_Cherry_Projects_Registration;
}