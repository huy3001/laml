...
<div class="tm-posts_button_wrap">
	<a href="<?php echo tm_builder_tools()->render_url( $this->_var( 'more_url' ) ); ?>" class=" <?php echo implode( ' ', $btn_classes ); ?>"<?php echo $this->prepare_atts( $atts ); ?>>
		<?php echo esc_html( $this->_var( 'more_text' ) ); ?>
	</a>
</div>